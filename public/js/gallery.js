...
const ARTWORKS = [
  {
    id: 1,
    title: 'Ondulation',
    description: "La souris pour déformer les ondulations",
    color: 0xc8a8ff,
  ...
  },
  {
    ...
    description: 'Les particules sont repoussés, cliquez pour inverser',
    color: 0x7af4f4,
    wallColor: new THREE.Color(0.06, 0.03, 0.14),
  },
  {
    id: 3,
    title: 'Kaleidoscope',
    description: 'La souris déclenche un mouvement dans le kaleidoscope',
    color: 0xf4a87a,
    wallColor: new THREE.Color(0.06, 0.03, 0.14),
  },
  {
    id: 4,
    title: 'Fractal',
    description: "La souris oriente le tunnel",
    color: 0xa0e8ff,
    wallColor: new THREE.Color(0.06, 0.03, 0.14),
  },
];
